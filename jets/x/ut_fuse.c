           ...
           u3_noun bix)
  {
    ...
    if ( c3n == u3du(sut) ) switch ( sut ) {
      ...
      case c3__atom: u3x_cell(u3t(sut), &p_sut, &q_sut);
      {
        if ( c3y == u3du(ref) ) {
          if ( c3__atom == u3h(ref) ) {
            ...
            {
              u3_noun foc = (c3y == u3qx_fitz(p_ref, p_sut))
                              ? u3k(p_sut)
                              : u3k(p_ref);
      ...
      case c3__face: u3x_cell(u3t(sut), &p_sut, &q_sut);
      {
        ...
        u3_noun ret = u3qx_face(p_sut, vot);
      ...
      case c3__fork: p_sut = u3t(sut);
      {
        ...
        u3_noun ret = u3kx_fork(_fuse_in_fork(van, yed, ref, bix));
...
*/
  ...
  u3wxu_fuse(u3_noun cor)
  {
         ...
         (u3_none == (sut = u3r_at(u3x_sam, van))) )
    {
      ...
      return _cqxu_fuse(van, sut, ref);
    }
  }

  u3_noun
  u3qxu_fuse(u3_noun van,
             u3_noun sut,
             u3_noun ref)
  {
    c3_m    fun_m = c3__fuse + !!u3r_at(u3qxu_van_vet, van);
