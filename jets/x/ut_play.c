...
# define _play_used()
             ...
             u3_noun rag)
  {
    while ( 1 ) {
      if ( c3n == u3du(mew) ) {
        ...
        u3_noun ruz = u3qxu_toss(van, sut, pi_mew, laf, rag);
                 ...
                 u3_noun rig)
  {
    ...
    u3_noun ret = u3qxu_fire(van, sut, rag);
           ...
           u3_noun gen)
  {
    ...
    if ( c3n == u3du(gen) ) {
      ...
      _play_used();
      {
        ...
        u3_noun pro = u3qxu_wrap(van, boc, c3__iron);
      ...
      {
        u3_noun boc = _play_x(van, sut, p_gen);
        u3_noun pro = u3qxu_wrap(van, boc, c3__zinc);
      ...
      {
        u3_noun boc = _play_x(van, sut, p_gen);
        u3_noun pro = u3qxu_wrap(van, boc, c3__lead);
      ...
      _play_used();
      {
        ...
        u3_noun ret = u3qxu_conk(van, boc, p_gen);
...
*/
  ...
  u3wxu_play(u3_noun cor)
  {
         ...
         (u3_none == (sut = u3r_at(u3x_sam, van))) )
    {
      ...
      return _cqxu_play(van, sut, gen);
    }
  }

  u3_noun
  u3qxu_play(u3_noun van,
             u3_noun sut,
             u3_noun gen)
  {
    return _cqxu_play(van, sut, gen);
