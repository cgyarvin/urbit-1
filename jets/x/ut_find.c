...
#include "all.h"
                  ...
                  u3_noun gil)
  {
    ...
    u3x_cell(rq_sut, &prq_sut, &qrq_sut);
    {
      if ( u3_nul == q_heg ) {
        ...
        u3_noun zem = u3qx_look(u3t(q_heg), qrq_sut);
        ...
        if ( u3_nul != zem ) {
          ...
          u3_noun pec = u3qxu_perk(van, sut, way, pq_sut);
          u3_noun pro;
          ...
          if ( c3n == u3h(pec) ) {
            ...
            u3_noun sam = u3qxu_peek(van, p_sut, way, 2);
    ...
    if ( c3y == u3r_sing(hax, yor) ) {
      ...
      if ( (c3n != u3h(yor)) ) {
        ...
        if ( (c3n != u3h(p_hax)) || (c3n != u3h(p_yor)) ) {
          ...
          return u3nq(c3n,
                      c3n,
                      u3kx_fork(u3nt(u3k(ppp_hax), u3k(ppp_yor), u3_nul)),
                      u3k(qpp_hax));
        }
      }
    }
          ...
          if ( c3y == u3h(qp_hax) ) {
            if ( c3y != u3h(qp_yor) ) {
              ...
              return 
                u3nq(c3y,
                     u3k(pp_hax),
                     c3y,
                     u3kx_fork(u3nt(u3k(pqp_hax), u3k(pqp_yor), u3_nul)));
            }
          }
            ...
            if ( c3n == u3r_sing(pqp_hax, pqp_yor) ) {
              ...
              return 
                u3nt(c3y, 
                     u3k(pp_hax),
                     u3nt(c3n, u3k(pqp_hax), u3qdy_uni(qqp_hax, qqp_yor)));
            }
          }
        }
      }
                  ...
                  u3_noun gil)
  {
    ...
    u3_noun yed = u3qdy_tap(p_sut, u3_nul);
    u3_noun wiz;
    u3_noun ret;
                       ...
                       u3_noun gil)
  {
    if ( u3_nul == qp_sut ) {
      ...
      u3_noun tiv = u3qxu_mint            //  (pair span nock)
      ...
      if ( u3_nul == fid ) {
        ...
        ret = u3nq
          (c3n, 
           c3n, 
           u3k(u3h(vat)), 
           u3qx_comb(u3t(vat), u3qx_comb(dog, q_tiv)));
                  ...
                  u3_noun gil)
  {
    ...
    if ( u3_nul == q_heg ) {
      ...
      if ( c3y == u3ud(p_sut) ) {
        ...
        u3_noun tyr = u3qdz_get(pp_sut, uq_heg);  //  (unit (unit port))
        ...
        if ( u3_nul == tyr ) {
          ...
          if ( u3_nul == u_tyr ) {
            ...
            u3_noun tor = u3qxu_fund(van, sut, way, uu_tyr);
            ...
            if ( c3y == u3h(tor) ) {
              ...
              ret = u3nq(c3n, c3n, u3k(pp_tor), u3qx_comb(dog, qp_tor));
              u3z(dog);
              u3z(tor); 
              u3z(tyr);
             ...
             u3_noun gil)
  {
    if ( c3n == u3du(sut) ) switch ( sut ) {
      ...
      {
        // fprintf(stderr, "hold\r\n");
        if ( (c3y == u3qdy_has(gil, sut)) ) {
          return u3_nul;
        }
        else {
          u3_noun zoc = u3qdy_put(gil, sut);
          u3_noun fop = u3qxu_repo(van, sut);
             ...
             u3_noun p_mor)                //  palo
  {
    ...
    {
      u3_noun ref    = u3qxu_felt(van, sut, qp_mor);
    ...
    if ( u3_nul == hyp ) {
      ...
      if ( c3n == u3h(mor) ) {
        ...
        if ( c3y == u3h(p_mor) ) {
          ...
          u3_noun fex = u3qxu_mint(van, ppp_mor, c3__noun, gen);
          u3_noun ret = u3nq(c3n, 
                             c3n,
                             u3k(u3h(fex)),
                             u3qx_comb(qpp_mor, u3t(fex)));
          u3z(fex);
          u3z(gen);
          u3z(mor);
...
*/
  ...
  u3wxu_find(u3_noun cor)
  {
         ...
         (u3_none == (sut = u3r_at(u3x_sam, van))) )
    {
      ...
      return _cqxu_find(van, sut, way, hyp);
    }
  }

  u3_noun
  u3qxu_find(u3_noun van,
             u3_noun sut,
             u3_noun way,
             u3_noun hyp)
  {
    c3_m    fun_m = c3__find + !!u3r_at(u3qxu_van_vet, van);
    ...
    if ( u3_none != pro ) {
      ...
      pro = _cqxu_find(van, sut, way, hyp);
...
*/
  ...
  u3wxu_fond(u3_noun cor)
  {
         ...
         (u3_none == (sut = u3r_at(u3x_sam, van))) )
    {
      ...
      return _cqxu_fond(van, sut, way, hyp);
    }
  }

  u3_noun
  u3qxu_fond(u3_noun van,
             u3_noun sut,
             u3_noun way,
             u3_noun hyp)
  {
    c3_m    fun_m = c3__fond + !!u3r_at(u3qxu_van_vet, van);
    u3_noun pro   = u3z_find_3(fun_m, sut, way, hyp);
    ...
    if ( u3_none != pro ) {
      ...
      pro = _cqxu_fond(van, sut, way, hyp);
