...
** specifically, s/hyr/gyr/g (already done?)
...
*/
            ...
            u3_noun b)
  {
    if ( u3_nul == a ) {
      ...
      if ( (c3n == u3r_cell(a, &n_a, &lr_a)) ) {
      ...
      else if ( c3y == u3qc_vyr(p_n_a, p_n_b) ) {
        if ( c3y == u3r_sing(p_n_a, p_n_b) ) {
          return u3nt(
            u3k(n_b),
            u3qdz_int(u3k(l_a), u3k(l_b)),
            u3qdz_int(u3k(r_a), u3k(r_b)));
        }
        else if ( c3y == u3qc_gyr(p_n_b, p_n_a) ) {
          return u3qdz_uni(
            u3qdz_int(u3k(l_a),
                      u3nt(u3k(n_b),
                           u3k(l_b),
        ...
        return u3nt(
          u3k(n_b),
          u3qdz_int(u3k(l_b), u3k(l_a)),
          u3qdz_int(u3k(r_b), u3k(r_a)));
      }
      else if ( c3y == u3qc_gyr(p_n_a, p_n_b) ) {
        return u3qdz_uni(
          u3qdz_int(u3k(l_b),
                    u3nt(u3k(n_a),
                         u3k(l_a),
