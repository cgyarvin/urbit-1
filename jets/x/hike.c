            ...
            u3_noun pac)
  {
    if ( (u3_nul == pac) ) {
      ...
      if ( u3_nul != zet ) {
        ...
        u3_noun zip = u3qx_hike(hax, tum);
        u3_noun dof = u3qx_hike(moz, gam);
        u3_noun fol = u3qx_cons(zip, dof);
