...
*/
  ...
  */
        ...
        if ( (c3n == u3du(qn_dab)) || (c3n == u3du(qn_hem)) ) {
          ...
          case c3__ash: {
            if ( c3__ash != u3h(qn_hem) ) {
              ...
              u3_noun vis = u3qxu_play(van, sut, pqn_dab);
              u3_noun lon = u3qxu_play(van, ref, pqn_hem);
             ...
             u3_noun gil)
  {
                        ...
                        (van, qq_ref, tel, p_ref, u3_nul, u3_nul, gil)) )
    {
           ...
           (c3__gold != pq_ref) ) 
      {
        ...
        if ( (c3y == u3qdy_has(gil, hud)) ) {
          u3z(hud);

          return c3y;
        }
        else {
          u3_noun zoc = u3qdy_put(gil, hud);
          ...
          if ( c3n == ret ) {
            ...
            switch ( pq_sut ) {
              ...
              case c3__iron: {
                u3_noun s_sam = u3qxu_peek(van, qq_sut, c3__rite, 2);
                u3_noun r_sam = u3qxu_peek(van, qq_ref, c3__rite, 2);
              ...
              case c3__zinc: {
                u3_noun s_pal = u3qxu_peek(van, qq_sut, c3__read, 2);
                u3_noun r_pal = u3qxu_peek(van, qq_ref, c3__read, 2);
                u3_noun ret = _nest_dext
                ...
                u3_noun gil)
  {
    ...
    if ( (c3n == u3du(sut)) ) switch ( sut ) {
      ...
      case c3__fork: p_sut = u3t(sut);
      {
        ...
        {
          u3_noun dey = u3qdy_tap(p_sut, u3_nul);
          u3_noun yed = dey;
...
#if 0
      u3_noun dun = u3qxu_dunq(van, "need", sut);
      u3_noun niz = u3qxu_dunq(van, "have", ref);
             ...
             u3_noun gil)
  {
    ...
    {
      c3_m    fun_m = c3__nest + !!u3r_at(u3qxu_van_vet, van);
             ...
             u3_noun gil)
  {
    ...
    if ( (c3n == u3du(ref)) ) {
      ...
      switch ( u3h(ref) ) {
        ...
        case c3__core: {
          u3_noun gam = u3qxu_repo(van, ref);
        ...
        {
          u3_noun dey = u3qdy_tap(p_ref, u3_nul);
          u3_noun yed = dey;
...
*/
  ...
  u3wxu_nest(u3_noun cor)
  {
         ...
         (u3_none == (sut = u3r_at(u3x_sam, van))) )
    {
      ...
      return _cqxu_nest(van, sut, tel, ref);
    }
  }

  u3_noun
  u3qxu_nest(u3_noun van,
             u3_noun sut,
             u3_noun tel,
             u3_noun ref)
  {
