    ...
    if ( c3y == u3ud(sut) ) switch ( sut ) {
      ...
      case c3__cell: {
        if ( (c3n == u3r_trel(sut, 0, &p_sut, &q_sut)) ) {
          ...
          u3_noun hob = u3qx_flan(hed, tal);
          u3_noun vug = u3qx_flan(hut, hob);
      ...
      case c3__hold: {
        p_sut = u3t(sut);
        {
          if ( (c3y == u3qdy_has(vit, sut)) ) {
            //  u3_noun dun = u3qxu_dunq(van, "type", sut);
            u3_noun niz = u3qxu_shep
              (van, "axis", 'd', u3k(axe));
...
*/
  ...
  u3wxu_fish(u3_noun cor)
  {
         ...
         (u3_none == (sut = u3r_at(u3x_sam, van))) )
    {
      ...
      return _cqxu_fish(van, sut, axe);
    }
  }

  u3_noun
  u3qxu_fish(u3_noun van,
             u3_noun sut,
             u3_noun axe)
  {
    c3_m    fun_m = c3__fish + !!u3r_at(u3qxu_van_vet, van);
