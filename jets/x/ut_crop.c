...
*/
  ...
  _crop_repo(u3_noun van,
             ...
             u3_noun bix)
  {
    u3_noun rep = u3qxu_repo(van, sut);
    ...
    if ( c3n == u3du(sut) ) switch ( sut ) {
      ...
      case c3__cell: u3x_cell(u3t(sut), &p_sut, &q_sut);
      {
        if ( c3__atom == u3h(ref) ) {
          ...
          if ( c3y == u3qxu_nest(van, p_ref, c3n, p_sut) )
          {
            u3_noun foz = _crop_dext(van, q_sut, q_ref, bix);
            u3_noun ret = u3qx_cell(p_sut, foz);
      ...
      case c3__face: u3x_cell(u3t(sut), &p_sut, &q_sut);
      {
        ...
        u3_noun ret = u3qx_face(p_sut, foz);
      ...
      case c3__fork: p_sut = u3t(sut);
      {
        ...
        u3_noun ret = u3kx_fork(_crop_dext_fork(van, yed, ref, bix));
      ...
      case c3__hold:
      {
        ...
        if ( c3y == u3qdy_has(bix, hud) ) {
#         if 0
            u3_noun dun = u3qxu_dunq(van, "type", sut);
            u3_noun niz = u3qxu_dunq(van, "over", ref);
...
#         endif
             ...
             u3_noun bix)
  {
    ...
    switch ( u3h(ref) ) {
      ...
      {
        u3_noun yed = u3qdy_tap(p_ref, u3_nul);
      ...
      case c3__hold:
      {
        u3_noun rep = u3qxu_repo(van, ref);
...
*/
  ...
  u3wxu_crop(u3_noun cor)
  {
         ...
         (u3_none == (sut = u3r_at(u3x_sam, van))) )
    {
      ...
      return _cqxu_crop(van, sut, ref);
    }
  }

  u3_noun
  u3qxu_crop(u3_noun van,
             u3_noun sut,
             u3_noun ref)
  {
    c3_m    fun_m = c3__crop + !!u3r_at(u3qxu_van_vet, van);
