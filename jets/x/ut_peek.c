...
*/
  u3_noun
  _cqxu_peek(u3_noun, u3_noun, u3_noun, u3_atom);
    ...
    if ( (c3n == u3du(sut)) ) switch ( sut ) {
      ...
      case c3__cell: {
        if ( (c3n == u3r_trel(sut, 0, &p_sut, &q_sut)) ) {
          ...
          if ( 2 == tip ) {
            pro = _cqxu_peek(van, p_sut, way, tap);
          }
          else {
            pro = _cqxu_peek(van, q_sut, way, tap);
          }
          u3z(tap);
          u3z(tip);
      ...
      case c3__core: {
             ...
             (c3n == u3r_cell(rq_sut, &prq_sut, &qrq_sut)) )
        {
          ...
          if ( 3 == now ) {
            ...
            if ( c3y == c3a(sam, con) ) {
              pro = _cqxu_peek(van, p_sut, way, lat);
            }
            else {
              u3_noun typ;

              {
                ...
                if ( c3n == sam ) {
                  ...
                  hed = _cqxu_peek(van, p_sut, way, 2);
                }

                if ( c3n == con ) {
                  tal = c3__noun;
                } else {
                  tal = _cqxu_peek(van, p_sut, way, 3);
                }

                typ = u3qx_cell(hed, tal);
                u3z(hed);
                u3z(tal);
              }

              pro = _cqxu_peek(van, typ, way, lat);
              u3z(typ);
            }
      ...
      case c3__fork: p_sut = u3t(sut);
      {
        ...
        u3_noun ret = u3kx_fork(_peek_fork(van, yed, way, axe, gil));
...
*/
  ...
  u3wxu_peek(u3_noun cor)
  {
         ...
         (u3_none == (sut = u3r_at(u3x_sam, van))) )
    {
      ...
      return _cqxu_peek(van, sut, way, axe);
    }
  }

  u3_noun
  u3qxu_peek(u3_noun van,
             u3_noun sut,
             u3_noun way,
             u3_noun axe)
  {
    c3_m    fun_m = c3__peek + !!u3r_at(u3qxu_van_vet, van);
    ...
    if ( u3_none != pro ) {
      ...
      pro = _cqxu_peek(van, sut, way, axe);
