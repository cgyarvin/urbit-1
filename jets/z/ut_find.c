      ...
      if ( u3_nul == fid ) {
        ...
        ret = u3nq
          (c3n, 
           c3n, 
           u3k(u3h(vat)), 
           u3qz_comb(u3qz_comb(dog, q_tiv), u3t(vat)));
      ...
      if ( c3y == u3ud(p_sut) ) {
        ...
        if ( u3_nul == tyr ) {
          ...
          if ( u3_nul == u_tyr ) {
            ...
            u3_noun tor = u3qzu_fund(van, sut, way, uu_tyr);
            ...
            if ( c3y == u3h(tor) ) {
              ...
              ret = u3nq(c3n, c3n, u3k(pp_tor), u3qz_comb(dog, qp_tor));
              u3z(dog);
              u3z(tor); 
              u3z(tyr);
    ...
    if ( u3_nul == hyp ) {
      ...
      if ( c3n == u3h(mor) ) {
        ...
        if ( c3y == u3h(p_mor) ) {
          ...
          u3_noun fex = u3qzu_mint(van, ppp_mor, c3__noun, gen);
          u3_noun ret = u3nq(c3n, 
                             c3n,
                             u3k(u3h(fex)),
                             u3qz_comb(qpp_mor, u3t(fex)));
          u3z(fex);
          u3z(gen);
          u3z(mor);
...
*/
  ...
  u3qzu_find(u3_noun van,
             ...
             u3_noun hyp)
  {
    c3_m    fun_m = 147 + c3__find + ((!!u3r_at(u3qzu_van_vet, van)) << 8);
...
*/
  ...
  u3qzu_fond(u3_noun van,
             ...
             u3_noun hyp)
  {
    c3_m    fun_m = 147 + c3__fond + ((!!u3r_at(u3qzu_van_vet, van)) << 8);
    u3_noun pro   = u3z_find_3(fun_m, sut, way, hyp);
