...
*/
                ...
                u3_noun leg)
  {
    if ( u3_nul == leg ) {
      ...
      return u3nc(u3qxu_play(van, u3h(i_leg), u3t(i_leg)),
  ...
  _rest_in_stil(u3_noun van,
                u3_noun gar)
  {
    u3_noun gun = u3qdy_gas(u3_nul, gar);
    u3_noun yed = u3qdy_tap(gun, u3_nul);
                ...
                u3_noun leg)
  {
    if ( u3_nul == leg ) {
      ...
      return c3o(u3qdy_has(fan, u3h(leg)),
                   _rest_hit_fan(fan, u3t(leg)));
    }
  }

  u3_noun
  _cqxu_rest(u3_noun van,
             u3_noun sut,
             u3_noun leg)
  {
    u3_noun fan = u3r_at(u3qxu_van_fan, van);

    if ( c3y == _rest_hit_fan(fan, leg) ) {
      return u3m_error("rest-loop");
    }
    else {
      u3_noun naf = u3qdy_gas(fan, leg);
      u3_noun nav = u3i_molt(u3k(van), u3qxu_van_fan, u3k(naf), 0);
...
*/
  ...
  u3wxu_rest(u3_noun cor)
  {
         ...
         (u3_none == (sut = u3r_at(u3x_sam, van))) )
    {
      ...
      return _cqxu_rest(van, sut, leg);
    }
  }

  u3_noun
  u3qxu_rest(u3_noun van,
             u3_noun sut,
             u3_noun leg)
  {
    c3_m    fun_m = c3__rest + !!u3r_at(u3qxu_van_vet, van);
