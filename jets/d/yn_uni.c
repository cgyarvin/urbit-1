      ...
      if ( (c3n == u3r_cell(a, &n_a, &lr_a)) ) {
        ...
        if ( c3y == u3qc_vyr(n_a, n_b) ) {
          if ( c3n == u3r_cell(lr_a, &l_a, &r_a) ) {
            ...
            return u3nt(u3k(n_b),
                        u3kdy_uni(u3k(l_a), u3k(l_b)),
                        u3kdy_uni(u3k(r_a), u3k(r_b)));
          }
          else if ( c3y == u3qc_hyr(n_b, n_a) ) {
            return u3kdy_uni(u3nt(u3k(n_a),
                                  u3kdy_uni(u3k(l_a),
                                            u3nt(u3k(n_b),
                                                 u3k(l_b),
                                                 u3_nul)),
          ...
          else if ( c3y == u3qc_hyr(n_a, n_b) ) {
            return u3kdy_uni(u3k(r_a),
                             u3nt(u3k(n_b),
                                  u3kdy_uni(u3nt(u3k(n_a),
                                                 u3k(l_a),
                                                 u3_nul),
                                            u3k(l_b)),
                                  u3k(r_b)));
