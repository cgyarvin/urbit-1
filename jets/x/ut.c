...
#include "all.h"
             ...
             u3_noun     typ)
  {
    ...
    u3_lo_tank(0, u3n_kick_on(u3qxu_dunq(van, ugh_c, typ)));
  }

  //  shew: create a show core for mean
  //
  u3_noun
  u3qxu_shew(u3_noun van,
             u3_noun mol)
  {
  ...
  //
  u3_noun
  u3qxu_shep(u3_noun     van,
             const c3_c* paz_c,
             u3_noun     sty,
             u3_noun     mol)
  {
    return u3qxu_shew(van,
