             ...
             u3_noun gen)
  {
    ...
    switch ( tov ) {
      ...
      case c3y:
        von = u3k(van); break;
      case c3n:
        von = u3i_molt(u3k(van), u3qzu_van_vet, c3n, 0); break;
    }
    {
      u3_noun mil = u3qzu_mint(von, sut, c3__noun, gen);
      u3_noun fol = u3k(u3t(mil));
           ...
           u3_noun gen)
  {
    ...
    if ( c3n == u3du(gen) ) {
      ...
      _mint_used();
      {
        ...
        u3_noun wam = u3qzu_play(van, sut, nob);
      ...
      _mint_used();
      {
        ...
        u3_noun ret = u3nc(u3qz_help(p_gen, u3k(u3h(hum))),
                           u3k(u3t(hum)));
        u3z(hum);
        return ret;
      }
      ...
      _mint_used();
      {
        ...
        {
          u3_noun cag = u3qzu_burn(van, sut);
