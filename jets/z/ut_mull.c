...
# define _mull_used()
           ...
           u3_noun gen)
  {
    ...
    if ( c3n == u3du(gen) ) {
      ...
      u3_noun rex = u3qzp_open(ter, gen);
      ...
      _mull_used();
      {
        ...
        u3_noun nob = u3qzl_bunt(van, heb);
        u3_noun p_waz = u3qzu_play(van, sut, nob);
        u3_noun q_waz = u3qzu_play(van, dox, nob);
      ...
      _mull_used();
      {
        ...
        u3_noun ret = u3nc(u3qz_help(p_gen, u3h(vat)),
                           u3qz_help(p_gen, u3t(vat)));
      ...
      _mull_used();
      {
        return u3nc(u3qz_face(p_gen, sut), u3qz_face(p_gen, dox));
      }
...
*/
  ...
  u3qzu_mull(u3_noun van,
             ...
             u3_noun gen)
  {
    c3_m    fun_m = 147 + c3__mull + ((!!u3r_at(u3qzu_van_vet, van)) << 8);
