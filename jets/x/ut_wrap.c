...
#include "all.h"
  ...
  static u3_noun _cqxu_wrap(u3_noun, u3_noun, u3_noun);
  ...
  _wrap_fork(u3_noun van, u3_noun p_sut, u3_noun yoz)
  {
    if ( u3_nul == p_sut ) {
      ...
      return u3nc(_cqxu_wrap(van, u3h(p_sut), yoz),
                  _wrap_fork(van, u3t(p_sut), yoz));
    }
  }

  static u3_noun
  _cqxu_wrap(u3_noun van,
             u3_noun sut,
             u3_noun yoz)
  {
    u3_noun p_sut, q_sut;
    ...
    if ( c3n == u3du(sut) )  {
      ...
      case c3__fork: p_sut = u3t(sut);
      {
        ...
        u3_noun ret = u3kx_fork(_wrap_fork(van, yed, yoz));
      ...
      case c3__hold:
      {
        ...
        u3_noun pro = _cqxu_wrap(van, fop, yoz);
...
*/
  ...
  u3wxu_wrap(u3_noun cor)
  {
         ...
         (u3_none == (sut = u3r_at(u3x_sam, van))) )
    {
      ...
      return _cqxu_wrap(van, sut, yoz);
    }
  }

  u3_noun
  u3qxu_wrap(u3_noun van,
             u3_noun sut,
             u3_noun yoz)
  {
    return _cqxu_wrap(van, sut, yoz);
